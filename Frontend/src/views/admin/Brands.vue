<template>
  <div class="container">
    ...
    <div class="card" style="margin-bottom:16px;padding:14px 20px;display:flex;gap:12px;align-items:center">
      <input class="form-control" v-model="search" placeholder="Tìm thương hiệu…" style="max-width:300px" />
    ...
    <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
      <div class="modal">
        <div class="modal-title">{{ editingId ? 'Cập nhật thương hiệu' : 'Thêm thương hiệu mới' }}</div>
